import InfoCard from "@/components/player/InfoCard";import TeamCard from "@/components/player/TeamCard";
    ...
    <View style={styles.container}>
      <ScrollView nestedScrollEnabled>
        ...
        <View style={styles.bottomSection}>
          ...
          <PrimaryButton title="Withdraw Participation" onPress={() => setShowModal(true)} />
        </View>
      </ScrollView>
