      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.profileInfo}>
            ...
            <Text style={styles.idText}>ID 333</Text>
            </View>
            <Text style={styles.profileRole}>Player</Text>
            <Text style={styles.profileRole}>Dhaka</Text>
          </View>
        ...
        <View >
          <Text style={styles.performanceTitle}>Performance Profile</Text>

          <View style={styles.performanceCard}><View style={styles.performanceBoxFull}>
            <Text style={styles.performanceText}>
              Tournaments Joined - <Text style={styles.highlight}>38</Text>
            </Text>
          </View>
          ...
          <View style={styles.performanceRow}>
            <View style={styles.performanceBox}>
              <Text style={styles.performanceText}>
                Wins - <Text style={styles.highlight}>20</Text>
              </Text>
            </View>
            <View style={styles.performanceBox}>
              <Text style={styles.performanceText}>
                MOTM - <Text style={styles.highlight}>8</Text>
              </Text>
            </View>
          </View>
          ...
          <View style={styles.performanceRow}>
            <View style={styles.performanceBox}>
              <Text style={styles.performanceText}>
                Runs - <Text style={styles.highlight}>1200</Text>
              </Text>
            </View>
            <View style={styles.performanceBox}>
              <Text style={styles.performanceText}>
                Wickets - <Text style={styles.highlight}>18</Text>
              </Text>
            </View>
          </View></View>
        </View>
        ...
        <View style={styles.actionButtonContainer}>
          ...
          <TouchableOpacity style={styles.logoutButton} >
            <Text style={styles.logoutButtonText}>Add Player</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
