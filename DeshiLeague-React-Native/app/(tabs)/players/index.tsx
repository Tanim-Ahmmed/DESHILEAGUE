...
import HiringRequestIcon from '@/assets/icons/HiringRequestIcon';
...
const HomeScreen = () => {
  ...
  const handleNavigateToHiringRequest = () => {
    router.push('/players/tournament/hire-requests' );
  };

  const handleNavigateToProfile = () => {
    router.push('/players/profile' as any);
  };
  ...
  return (
    <View style={styles.filterContainer}>
      {filters.map((filter) => (
        ...
        >
          {/* Inner shadow overlay for active state */}
          {activeFilter === filter && (
            <View />
          )}
    ...
    <View style={styles.container}>
        ...
        <Header 
          ...
          rightComponent={
            <View style={styles.rightContainer}>
              <TouchableOpacity onPress={handleNavigateToHiringRequest}>
                <HiringRequestIcon/>
              </TouchableOpacity>
              <NotificationIcon/>
      ...
      >
        <View style={styles.section}>
          <Text style={[styles.sectionTitle,{color: theme.primaryTextColor}]}>My Tournaments</Text>
          <TournamentSlider 
            data={sliderData}
            autoScroll={true}
            autoScrollInterval={5000}
            dynamicRoute="players/tournament/details"
          />
        </View>
...
createButtonContainer: {
  ...
  activeFilter: {
    ...
    borderColor: '#0F1113', // Darker border for inner shadow effect
    
    // Reduced outer white glow
    shadowColor: '#FFFFFF',
    shadowOffset: { width: 0, height: 0 },
    shadowOpacity: 0.3,
    shadowRadius: 6,
